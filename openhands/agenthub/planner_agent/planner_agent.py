...
import openhands.agenthub.planner_agent.function_calling as planning_function_calling
...
class PlannerAgent(Agent):
    ...
    def __init__(
        ...
        logger.info(
            f"TOOLS loaded for Planner: {', '.join([tool.get('function').get('name') for tool in self.tools])}"
        )
