...
class TaskSolvingAgent(Agent):
    ...
    def __init__(
        ...
        built_in_tools = task_solving_function_calling.get_tools(
            task_solving_enable_browsing=self.config.task_solving_enable_browsing,
            task_solving_enable_jupyter=self.config.task_solving_enable_jupyter,
            task_solving_enable_llm_editor=self.config.task_solving_enable_llm_editor,
            llm=self.llm,
        )
    ...
    def step(self, state: State) -> Action:
        ...
        if self.mcp_tools and self.config.task_solving_enable_mcp_tools:
